...
class myBikesTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.row == 0 {
            return tableView.dequeueReusableCell(withIdentifier: "okayCell", for: indexPath)
        } else {
            return tableView.dequeueReusableCell(withIdentifier: "stolenCell", for: indexPath)
        }
    }
